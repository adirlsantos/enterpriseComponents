...
public interface CursoDAO extends JpaRepository<Curso, java.lang.String> {
   ...
   * @generated
   */
  @Query("SELECT entity FROM Turma entity WHERE entity.cursoSel.id = :id")
   ...
   * @generated
   */
  @Query("SELECT entity.instrutorSel FROM Turma entity WHERE entity.cursoSel.id = :id")
  public Page<Instrutor> listInstrutor_2(@Param(value="id") java.lang.String id, Pageable pageable);
   ...
   */
  @Modifying
  @Query("DELETE FROM Turma entity WHERE entity.cursoSel.id = :instanceId AND entity.instrutorSel.id = :relationId")
  public int deleteInstrutor_2(@Param(value="instanceId") java.lang.String instanceId, @Param(value="relationId") java.lang.String relationId);
